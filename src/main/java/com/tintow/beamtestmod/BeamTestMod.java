package com.tintow.beamtestmod;
...
@Mod(BeamTestMod.MOD_ID)
public class BeamTestMod
{
    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();
    public static final String MOD_ID = "beamtestmod";
    ...
    public BeamTestMod() {
        ...
        modEventBus.addListener(this::clientSetup); //register client setup
